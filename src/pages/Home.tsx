    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="container mx-auto px-4 py-5">
          <div className="flex justify-between items-center flex-wrap lg:flex-nowrap">
            ...
            <nav className="hidden md:flex order-2 lg:order-2">
              <ul className="flex gap-4 lg:gap-6">
                <li><a href="#home-section" className="hover:bg-white hover:bg-opacity-15 px-3 py-2 rounded transition-all text-sm lg:text-base">Home</a></li>
                <li><a href="#" className="hover:bg-white hover:bg-opacity-15 px-3 py-2 rounded transition-all text-sm lg:text-base">About</a></li>
                <li><a href="#services-section" className="hover:bg-white hover:bg-opacity-15 px-3 py-2 rounded transition-all text-sm lg:text-base">Services</a></li>
                <li><a href="#volunteer-section" className="hover:bg-white hover:bg-opacity-15 px-3 py-2 rounded transition-all text-sm lg:text-base">Volunteer</a></li>
                <li><a href="#contact-section" className="hover:bg-white hover:bg-opacity-15 px-3 py-2 rounded transition-all text-sm lg:text-base">Contact</a></li>
              </ul>
            </nav>
            ...
            <nav className="md:hidden w-full order-4 mt-4">
              <ul className="flex justify-center gap-4 text-sm">
                <li><a href="#home-section" className="hover:bg-white hover:bg-opacity-15 px-2 py-1 rounded transition-all">Home</a></li>
                <li><a href="#" className="hover:bg-white hover:bg-opacity-15 px-2 py-1 rounded transition-all">About</a></li>
                <li><a href="#services-section" className="hover:bg-white hover:bg-opacity-15 px-2 py-1 rounded transition-all">Services</a></li>
                <li><a href="#contact-section" className="hover:bg-white hover:bg-opacity-15 px-2 py-1 rounded transition-all">Contact</a></li>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8 space-y-12">
        ...
        <motion.section
          ...
          className="bg-white rounded-2xl shadow-lg p-6 md:p-8 lg:p-12 text-center"
        >
          <h3 className="text-2xl md:text-3xl font-bold text-blue-800 mb-4">Become a Volunteer</h3>
          <p className="text-gray-600 max-w-xl mx-auto text-sm md:text-base mb-6">
            Join our dedicated team and make a difference in students' lives. Your support can help shape the future.
          </p>
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 2.2, duration: 0.6 }}
            onClick={() => navigate('/register')}
            className="bg-blue-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-semibold text-base md:text-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover-element inline-flex items-center gap-2"
          >
      ...
      {/* Footer */}
      <footer id="contact-section" className="bg-red-800 text-white py-10 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-3 mb-5">
